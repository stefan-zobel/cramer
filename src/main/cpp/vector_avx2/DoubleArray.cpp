...
DoubleArray::DoubleArray(JNIEnv* env, jdoubleArray jarray, long length, jboolean critical)
    : ctx(static_cast<Context*>(env)), jarray(jarray), len(length), critical(critical == JNI_TRUE)
{
    if (jarray) {
